...
SimpleForm.setup do |config|
  ...
  config.button_class = 'btn shadow-none fw-bold p-3 btn-primary rounded-0'
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group mb-4', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.use :input, class: 'form-control shadow-none rounded-0 mb-1 p-2', error_class: 'is-invalid', valid_class: 'is-valid'
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end

  # vertical input for boolean
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'form-group mb-4 d-flex justify-content-end', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
